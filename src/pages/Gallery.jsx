      ...
      <div className="max-w-4xl mx-auto px-4 py-6">
        ...
        {!isLoading && photos.length === 0 && (
          <motion.div className="text-center py-16" {...fadeIn}>
            ...
            <p className="text-sm text-gray-300">Showcase your salon's best work</p>
          </motion.div>
        )}
        ...
        <motion.div className="grid grid-cols-2 sm:grid-cols-3 gap-3" variants={staggerContainer} initial="initial" animate="animate">
          <AnimatePresence>
            {photos.map((photo, i) => (
              <motion.div key={photo.id} variants={cardMotion} transition={{ ...cardMotion.transition, delay: i * 0.05 }} className="group relative bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 aspect-square">
